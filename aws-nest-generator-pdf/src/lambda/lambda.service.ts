...
export class LambdaService {
  private async getPdfFromPuppeter(transaction: { name: string, cod_operacion: string, monto: string, message: string }): Promise<Buffer> {
                                    ...
                                    <tr>
                                      ...
                                      >
                                        <p
                                          ...
                                          "
                                        >
                                         Se le comunica que la transaccion ${transaction.cod_operacion} con el valor del monto ${transaction.monto} ,
                                         ha sido ${transaction.message} .
                                        </p>
                                        <p
                                          style="
                                            margin: 0;
                                          ...
                                          "
                                        >
                                          <br />Esta comprobante estará disponible por
                                          unos 07 dias  .<br /><br />Saludos,<br />Empresa Cambio dolar
                                        </p>
                                      </td>
                                    </tr>
                                  </table>
   ...
   * @param transaction
   */
  public async buildPdf(transaction: { name: string, cod_operacion: string, monto: string, message: string }): Promise<string> {
